...
So yes, an open quantum OS sounds exciting. But given past adventures, I'd probably read the source code twice before running it.

Otherwise we might accidentally contribute our qubits to a global distributed cluster cracking RSA, mining "quantum coins",  or simulating the universe where CCP is the supreme power - all while we thought we were just compiling a hello-world circuit.
